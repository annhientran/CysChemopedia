...
(function($) {
	...
	$(document).ready( function() {
		if ($(".eupopup").length > 0) {
			...
			var textNode = document.createTextNode("The OxiMouse Website is using cookies.");
			var popupText = document.createTextNode('If you continue using our website, we\'ll assume that you are happy to receive all cookies on this website.');
			headerNode.appendChild(textNode).appendChild(paragraphNode).appendChild(popupText);
			document.getElementById('cookieDiv').appendChild(headerNode).className="text-light";
		}
	});
